...
const App = () => {
  ...
  const { contract: token } = useContract('0x708be83591301B5bD86729bd398eAa2C8C0323f7', 'token');
  const { contract: vote } = useContract("0x10d64667E3A17C0951C96D1Bc32EE6c8d1D76EA8", "vote");
